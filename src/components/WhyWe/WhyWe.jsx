			...
			<section className="why-we">
				<div className='why-we__container'>
					...
					<ul className="why-we__advantages advantages">
						...
						<AdvantagesItem icon={<FontAwesomeIcon icon={faToolbox} />} title="Custom Box" desc="Sit voluptatem accusantium dolore mque laudantium, totam rem aperiam, eaque ipsa quae ab illo." />
						<AdvantagesItem icon={<FontAwesomeIcon icon={faArrowsRotate} />} title="Quick Refund" desc="Sit voluptatem accusantium dolore mque laudantium, totam rem aperiam, eaque ipsa quae ab illo." />
					</ul>
				</div>
