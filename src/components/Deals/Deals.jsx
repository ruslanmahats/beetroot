				...
				<div className='wrapper'>
					<div className='deals__container'>
						...
						<div className='deals__image-container'>
							<img src='/beetroot/assets/images/design/splash.jpg' alt='deals__image' className='deals__image' />
						</div>
						<div className='deals__content-container'>
							...
							<p className='deals__text'>
								Quisquam minus maiores repudiandae nobis, minima saepe id, fugit ullam similique! Beatae, minima
								quisquam molestias facere ea. Perspiciatis unde omnis iste natus error sit voluptatem accusant
							</p>
							<Countdown date={Date.now() + (1734615204000 - Date.now())} renderer={renderer} />
							<div className='deals__btn'>
								<Button icon={<FontAwesomeIcon icon={faShoppingCart} />} text='Add to Cart' mod='solid' />
							</div>
						</div>
					</div>
				</div>
