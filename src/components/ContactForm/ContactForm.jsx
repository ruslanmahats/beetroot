		...
		<>
			<Formik
				...
				validationSchema={Yup.object({
					firstName: Yup.string().min(2, 'Name must be at least 2 symbols').required('Required'),
					lastName: Yup.string().min(2, 'Name must be at least 2 symbols').required('Required'),
					email: Yup.string().email('Invalid email address').required('Required'),
					textMessage: Yup.string().required('Required'),
				})}
