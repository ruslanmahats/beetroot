	...
	return (
		<>
			<div className="slider-comment">
				<div className="slider-comment__avatar-container"><img src={`/beetroot/assets/images/avatars/${avatarUrl}`} alt={`${userName} comment`} className="slider-comment__image" /></div>
