			...
			<div className='contact-section'>
				<div className='contact-section__form-container'>
					...
					<p className='contact-section__text'>
						...
						assumenda. Perferendis, quo alias quaerat aliquid. Corporis ipsum minus voluptate? Dolore, esse natus!
					</p>
				...
				<ul className='contact-section__adress-container'>
					<li className='contact-section__adress-item'>
						<div className='contact-section__adress-icon'>
					...
					<li className='contact-section__adress-item'>
						...
						<div className='contact-section__adress-text'>
							...
							<ul>
								<li>
									Phone: <a href='tel:+451115553333'>+45 111 555 3333</a>
								</li>
								<li>
									Email: <a href='mailto:support@fruitshop.com'>support@fruitshop.com</a>
								</li>
							</ul>
						</div>
					</li>
